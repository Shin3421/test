...
<?php include('message.php') ?>
    <!-- ======= Header ======= -->
    <header id="header" class="header fixed-top d-flex align-items-center" style="padding: 3px 25px;top: 0px; background: rgba(255, 224, 253, 0.55); backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); border: 1px solid rgba(255, 224, 253, 0.02);">
   ...
   <main id="main" class="main">
       ...
       <section class="section dashboard">
           ...
           <div class="container-fluid px-4">
                   ...
                   <h4 class="text-dark fw-bold lead mt-1">
                       Registered User 
                    <a  onclick="add_user()" class="btn float-end text-light" style="margin-left: 10px; background-color: #00c5ce;"><i class="fa fa-add fa-fw" ></i>
                        Add User
                   </a>
                   </h4>
               </div>
                           <div class="table table-responsive table-hover p-3">
                               <table class="" id="table_user">
                                   <thead>
                                       <tr>
                                           <th>ID</th>
                                           <th>Name</th>
                               ...
                               if($query_run->num_rows > 0)
                               {
                                   while($row = mysqli_fetch_array($query_run))
                                   {
                                       ...
                                       <tr>
                                           ...
                                           <a onclick="edit_user('<?php echo $user_id ?>', '<?php echo $fname ?>', '<?php echo $lname ?>', '<?php echo $number ?>', '<?php echo $address ?>','<?php echo $points ?>')" class="btn btn-success"><i class="fa fa-edit fa-fw"></i></a>&nbsp;
                                       </tr>
                                       <?php
                                   }
                               }
?>                     
    ...
    <?php include('message.php'); ?>
                <!-- Add Modal -->
<div class="modal fade custom-modal" id="add_modal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content center">
      ...
      <div class="modal-body">
        ...
        <input name="fname" id="fname" type="text" placeholder="Enter First Name" class="form-control mb-2" required>
        <label class="mb-1">Last Name</label>
        <input name="lname" id="lname" type="text" placeholder="Enter Last Name" class="form-control mb-2"required>
        <label class="mb-1">Number</label>
        <input name="number" id="number" type="text" placeholder="Enter Number" class="form-control mb-2">
        <label class="mb-1">Address</label>
        <input name="address" id="address" type="text" placeholder="Enter Address" class="form-control mb-2">
        <label class="mb-1">Password</label>
        <input name="password" id="password" type="password" placeholder="Enter Password" class="form-control mb-2">
        <label class="mb-1">Confirm Password</label>
        <input name="cpassword" id="cpassword" type="password" placeholder="Enter Password" class="form-control mb-2">
        <label class="mb-1">Email</label>
        <input name="email" id="email" type="email" placeholder="Enter Email" class="form-control mb-2" required>
      </div>
      <div class="modal-footer">
        <button type="submit" name="add_user_btn" id="add_user_btn" class="btn btn-primary">Add User</button>
      </div>
    </div>
  </div>
</div>
                ...
                <!-- Edit Modal -->
                <div class="modal fade custom-modal" id="edit_modal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content center">
      <div class="modal-header">
      ...
      <div class="modal-body">
      <form method="POST" action="code/code.php">
        <input  name="euser_id" id="euser_id" type="hidden" class="form-control mb-2" value="" >
        <label class="mb-1">First Name</label>
        <input  name="efname" id="efname" type="text" class="form-control mb-2" value="" required>
        <label class="mb-1">Last Name</label>
        <input name="elname" id="elname" type="text" class="form-control mb-2" value="" required>
        <label class="mb-1">Number</label>
        <input name="enumber" id="enumber" type="text"  class="form-control mb-2" value="">
        <label class="mb-1">Address</label>
        <input name="eaddress" id="eaddress" type="text"  class="form-control mb-2" value="">
        <label class="mb-1">Points</label>
        <input name="epoints" id="epoints" type="text" class="form-control mb-2" value="">
      </div>
      <div class="modal-footer">
        <button type="submit" name="update_user" id="update_user" class="btn btn-primary">Update user</button>
      </div>
    </div>
  </div>
</div>
        ...
        <script type="text/javascript">
            ...
            function edit_user(id,fname,lname,number,address,points)
            {
                $('#euser_id').val(id);
                $('#efname').val(fname);
                $('#elname').val(lname);

           ...
           <div class="table table-responsive table-hover p-3">
                                <table class="" id="history_table">
                                    <thead>
                                            ...
                                            <th style="text-align:center">Redeem Code</th>  
                                            <th style="text-align:center">Description</th> 
                                            <th style="text-align:center">Item Name</th> 
                                            <th style="text-align:center">Status</th>                          
                                            <th style="text-align:center">Date Redeemed</th>                              
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                $login_table = "SELECT A.*, B.*,C.* FROM redeemed_table as A INNER JOIN user_table as B ON A.user_id = B.user_id INNER JOIN redeemables_table AS C ON A.item_id = C.item_id ORDER BY redeemed_date DESC";
                ...
                if($login_table_result->num_rows > 0)
                {
                    ...
                    {
                        $date = date_create($rows['redeemed_date']);
            ?>
                                <tr>
                                    <td style="text-align:center"><?php echo $rows['fname']. $rows['lname']; ?></td>
                                    <td style="text-align:center"><?php echo $rows['redeem_code']; ?></td>
                                    <td style="text-align:center"><?php echo $rows['description']; ?></td>
                                    <td style="text-align: center;"><?php echo $rows['item_name'] ?></td>
                                             <td style="text-align: center;"><?php if($rows['r_status'] == '0') 
                                                        {
                                                            echo 'Redeemable';
                                                        }
                                                        elseif($rows['r_status'] == '1')
                                                        {
                                                            echo 'Redeemed';
                                                        }  
                                                        elseif($rows['r_status'] == '2')
                                                        {
                                                            echo 'Expired';
                                                        }     
                                                        ?>
                                    ...
                                    <td style="text-align:center"><span class="text-info"><?php echo $date->format("d M Y"); ?></span></td>
                                </tr>
                        <?php
                    }
                }

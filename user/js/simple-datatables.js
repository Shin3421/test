                ...
                (function() {
                    ...
                    var e = { exports: {} }.exports = function() {
                            ...
                            var $ = function() {
                                    ...
                                    return m.parse = function(t) {
                                        ...
                                        var i = t || "YYYY-MM-DDTHH:mm:ssZ",
                                            ...
                                            h = s.weekdays,
                                            l = s.months,
                                            d = function(t, s, a, n) { return t && (t[s] || t(e, i)) || a[s].slice(0, n) },
                                    ...
                                    }, m.daysInMonth = function() { return this.endOf(h).$D }, m.$locale = function() { return y[this.$L] }, m.locale = function(t, e) {
                                        if (!t) return this.$L;
                                        var s = this.clone(),
                                            i = C(t, e, !0);
                                        return i && (s.$L = i), s
                            ...
                            return x.prototype = T, [
                                ...
                                ["$y", d],
                                ["$D", c]
                            ].forEach((function(t) { T[t[1]] = function(e) { return this.$g(e, t[0], t[1]) } })), x.extend = function(t, e) { return t.$i || (t(e, $, x), t.$i = !0), x }, x.locale = C, x.isDayjs = w, x.unix = function(t) { return x(1e3 * t) }, x.en = y[v], x.Ls = y, x.p = {}, x
                        }(),
                        i = { exports: {} }.exports = function() {
                            var t = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" },
                                ...
                                c = {
                                    ...
                                    MMM: [a, function(t) {
                                        var e = l("months"),
                                            s = (l("monthsShort") || e.map((function(t) { return t.slice(0, 3) }))).indexOf(t) + 1;
            ...
            class l {
                ...
                sort(e, s, i) {
                    ...
                    if ("date" === u.getAttribute("data-type")) {
                        let e = !1;
                        u.hasAttribute("data-format") && (e = u.getAttribute("data-format")), p.push(Promise.resolve().then((function() { return t("./date-7061ceee.js") })).then((({ parseDate: t }) => s => t(s, e))))
                    }
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.dom.tHead) {
                            this.options.scrollY.length && (e = a("thead"), e.appendChild(a("tr")), e.style.height = "0px", this.headerTable && (this.dom.tHead = this.headerTable.tHead)), this.activeHeadings.forEach((t => { t.style.width = "" }));
                    ...
                    if (s.data.length || i(s.data)) {
                        if ("csv" === s.type) {
                            ...
                            t.length && (s.headings && (e.headings = t[0].split(s.columnDelimiter), s.removeDoubleQuotes && (e.headings = e.headings.map((t => t.trim().replace(/(^"|"$)/g, "")))), t.shift()), t.forEach(((t, i) => {
                                ...
                                a.length && a.forEach((t => { s.removeDoubleQuotes && (t = t.trim().replace(/(^"|"$)/g, "")), e.data[i].push(t) }))
                            })))
                        } else if ("json" === s.type) {

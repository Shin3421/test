...
?>
     <!-- required fields -->
     <div class="row">
<div class="col" id="resched_services">
                <a >Service Type<a style="color: red;">*</a></a>
                  <div class="form-group">
                    <select style
                    name="resched_service_type" id="resched_service_type" class="form-control mt-2" required>
                          <option value="" style="text-align: center;">- Service Type -</option>
...
<div class="col ">
      <a >Machine to use Max. of 2<a style="color: red;">*</a></a>
        <div class="form-group">
          <input id="resched_machine_used" name="resched_machine_used" type="number" class="form-control mt-2" min="1" max="2" value="1">
        </div>
</div>
...
<div class="form-group">
            ...
            <div class="form-group">
                  <button  style="left: 0px; right: 0px; width: 100%;" type="submit" class="btn btn-info" id="btn_resched_submit" name="btn_resched_submit" disabled>Re-schedule</button>
                  </div>
          </div>
</div>

...
<div class="col" id="services">
                <a >Service Type<a style="color: red;">*</a></a>
                  <div class="form-group">
                    <select style
                    name="service_type" id="service_type" class="form-control mt-2" required>
...
<div class="form-group">
            ...
            <div class="form-group">
                  <button  style="left: 0px; right: 0px; width: 100%;" type="submit" class="btn btn-info" id="btn_book_submit" name="btn_book_submit" disabled>Book Now</button>
                  </div>
          </div>
</div>

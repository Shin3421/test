        ...
        <div class="col-md-12"  >
            <div class="card"  >
                <div class="card-header" style="background: white;">
                    <h4 class="font-weight-bold" style="color: #980799; text-align: center;">Edit Password
                  </h4>   
                </div>
                <div class="card-body">
            <?php
 ...
 <div id="cont_footer" class="footer-container border-top" style="color: #980799;">
      ...
      <footer class="py-2 my-4">
        <ul class="nav justify-content-center pb-3 mb-3">
          ...
          <li class="nav-item">
            <a href="about-us.php" class="nav-link px-2">About</a>
          </li>
          <li class="nav-item">
            ...
            <div class="modal-content">
               ...
               ?> 
                ...
                <div class="modal-body">
                    ...
                    <button onclick="window.location.href='profile.php.php'" style="width: 100%;" type="submit" class="btn btn-secondary">Go to schedules</button>
                        </div>
                    </div>
                    </div>
                </div>
